...
\usepackage[left=2cm,top=2cm,right=2cm,bottom=0cm,head=0cm,foot=0cm]{geometry}
\usepackage{notes}
...
% &= \frac{ 2(\x\cdot\mu_C - \x\cdot\mu_D) + |\mu_D|^2 - |\mu_C|^2}{\sigma^2} + \log \frac{\pi_C}{\pi_D} + \log \frac{L(C \to D)}{L(D \to C)} \\
