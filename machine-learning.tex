...
\begin{tabular}{l|l|l|l}
  ...
  \textbf{Ouput layer}  & $\vec \yhat = \sigma(\mat W \z)$ & $\yhat_k$ & $K \times 1$ \\
...
\item Initial $W = \matrixiijj{0}{0}{0}{0}$
\item $Wz = \matrixiijj{0}{0}{0}{0} \cvec{0}{1} = \cvec{0}{0}$
\item $\yhat = \cvec{s(0)}{s(0)} = \cvec{0.5}{0.5}$
\end{enumerate}
