...
\begin{proof}
  \begin{align*}
    ...
    &= \frac{1}{n!}\sum_{k=0}^\infty\frac{1}{n+1}\cdot\frac{1}{n+2}\cdots\frac{1}{n + k + 1}\\
    &= \frac{1}{n!}\frac{1}{n+1}\sum_{k=0}^\infty\frac{1}{n+2}\cdot\frac{1}{n+3}\cdots\frac{1}{n + k + 1}\\
    &< \frac{1}{nn!}\sum_{k=0}^\infty\frac{1}{n^2}\red{...INCOMPLETE}
  \end{align*}
\end{proof}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    s_n &= \frac{13}{15} - \(\frac{1}{7} - \frac{1}{9}\) - \(\frac{1}{11} - \frac{1}{13}\) - \ldots
          < \frac{13}{15}.
  \end{align*}
  ...therefore $\frac{2}{3} < \lim_{n \to \infty} s_n < \frac{13}{15}$.
\end{proof}
