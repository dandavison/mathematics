...
\usepackage{notes}
\usepackage{fullpage,amsfonts,amsmath,amssymb,mathpazo,graphicx,verbatim,parskip}
...
%\footnote{Notes from the [Essence of Linear Algebra](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab) video series by [3blue1brown](http://www.3blue1brown.com/).}
...
% \footnote{https://www.reddit.com/r/math/comments/3uoa6d/motivation_for_positive_definite_matrices_brief/cxh21jg/}
