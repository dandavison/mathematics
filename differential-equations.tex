...
by some $M_n$, and that the series $\sum_{n=1}^\infty M_n$ converges.

A single term in the series is
\begin{align*}
  e_{n+1}(t) = \int_{t_0}^t v\Big(\tau, y_n(\tau)\Big) -
...
\begin{align*}
  \Big|e_{n+1}(t)\Big| \leq L\Bigg|\int_{t_0}^t \Big|y_n(\tau) - y_{n-1}(\tau)\Big| \d\tau \Bigg|.
\end{align*}
