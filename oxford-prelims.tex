...
\subsubsection*{}
\begin{mdframed}
\includegraphics[width=200pt]{img/oxford-prelims-2017-A-1-1-2.png}
\end{mdframed}
...
Then for all $w \in V$ there exist unique coordinates $a_1, \ldots, a_n$ such that
\begin{align*}
...
It remains to show that $v_1, v_2, \ldots, v_n$ are linearly independent.

I want to say: we know that $v_1, v_2, \ldots, v_n$ span $V$, and this spanning
set is the same size as a known basis, therefore this spanning set is also
