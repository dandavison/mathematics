...
\begin{proof}~\\
  ...
  combination of $\{u, v_2, \ldots, v_n\}$ \footnote{
...
\begin{proof}
  For the forwards implication, suppose $\cvec{a}{b}$ and $\cvec{c}{d}$ are
  linearly independent and suppose, for a contradiction, that $ad - bc = 0$.
  ...
  For the reverse implication, suppose $ad - bc \neq 0$.
\end{proof}
