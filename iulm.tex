...
\red{TODO: to get round this problem, take an arbitrary set $X'$ of size $n+1$
  and create a set $X$ of size $n$ by removing an element from it. Then the
  result holds for $X$ by assumption if we can show that it holds for $X'$ then
  we have shown it holds for any...?}
