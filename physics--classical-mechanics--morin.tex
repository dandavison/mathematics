...
\blue{However, $V(x)$ is only well-defined if that integral does not depend on the path taken in
  space. So potential energy is defined only for such a \emph{conservative} force.
  \emph{Work} is
}



\subsubsection{Example: gravitational potential energy}
