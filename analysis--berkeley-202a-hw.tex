...
\item
  ...
  \begin{proof}
    ...
    \end{align*}
    Now, for $x \in C^c$, the value of the integral to the left is constant as $n$ increases (\red{TODO}).
    I.e. $\int_0^a f_{n+1}(t) \dt - \int_0^a f_{n}(t) \dt = 0$ and we have (using lemma \eqref{lemma-4-1-1})
    \begin{align*}
