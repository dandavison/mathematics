...
\item \begin{claim*}
  ...
  \begin{proof}
    ...
    To show that $C$ is closed we may show that $C^c$ is open. Since $C = \bigcap_{n=0}^\infty C_n$, we have
    \begin{align*}
...
\item \begin{claim*}
  ...
  \begin{proof}
    ...
    of $C_n$ is $(2/3)^n$ (i.e. it decreases monotonically with $n$). We want to find an iteration $n$ such that
    \begin{align*}
      (2/3)^n < \eps.
    \end{align*}
    Set $m = \Big\lceil\frac{\log\eps}{\log 2/3} \Big\rceil$. We see that for all $n > m$ we have $|C_n| < \epsilon$.
...
\item
  \begin{claim*}
    Does the occupation fraction $O_n(I, \lambda)$ have a limiting value and if so what is it?
  \end{claim*}
  \begin{proof}
    \red{TODO}
  \end{proof}
