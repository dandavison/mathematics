...
% 5. Your proof of (3) is morally correct (though I can't parse the sentence before "Therefore f is continuous.") though missing some details (WTS f is linear on a dense set); your intution that (1), (2) should follow from (3) is also correct, but need to be filled in. (-4) You should also check that a suitable a exists. (-2)
% Aidan Backus, Oct 20 at 6:59pm
% 6.2) Your intuition is correct. However, I don't think you strategy of considering complements will really help much. (-4)
% Ian Francis, Oct 31 at 11:25am
% 1. 10 4. 10 5. 4 6. 6
% Ian Francis, Oct 31 at 11:36am
...
% 5. Your proof of (3) is morally correct (though I can't parse the sentence before "Therefore f is continuous.")
% though missing some details (WTS f is linear on a dense set); your intution that (1), (2) should follow from
% (3) is also correct, but need to be filled in. (-4) You should also check that a suitable a exists. (-2)
