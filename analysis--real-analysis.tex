...
\section{Theorems}
\begin{theorem*}[Limit of product is product of limits]~\\
  Let $\lim_{x\to a}f(x) = L_f$ and $\lim_{x\to a}g(x) = L_g$. Then
  $\lim_{x\to a}f(x)g(x) = L_fL_g$.
\end{theorem*}

\begin{proof}
  Note that
  \begin{align*}
    \lim_{x\to a} f(x)g(x) &= \lim_{x\to a} \Big((f(x) - L_f)(g(x) - L_g) + L_fg(x) + L_gf(x) - L_fL_g\Big)\\
                          &= L_fL_g + \lim_{x\to a} (f(x) - L_f)(g(x) - L_g),
  \end{align*}
  so we need to show that $\lim_{x\to a} (f(x) - L_f)(g(x) - L_g) = 0$.
...
\begin{theorem*}[Limit of quotient is quotient of limits]~\\
  Let $\lim_{x\to a}f(x) = L_f$ and $\lim_{x\to a}g(x) = L_g \neq 0$. Then
  \begin{align*}
...
\begin{proof}
  \begin{align*}
    ...
    = \lim_{x\to a}\frac{f(x)}{g(x)} - \frac{1}{g(x)} + \frac{1}{g(x)} - \frac{L}{M}
  \end{align*}
\end{proof}

\begin{proof}~\\
  Let $L_f = \lim_{x\to a}f(x)$ and $L_g = \lim_{x\to a}g(x) \neq 0$.
...
\begin{proof}~\\
  Let $a \in \R$. The claim is that $\lim_{x\to a} f(x) - f(a) = 0$. Since $f$ is differentiable,
  \begin{align*}
    f'(a) &= \lim_{x \to a} \frac{f(x) - f(a)}{x - a}
%          = \frac{\lim_{x \to a} f(x) - f(a)}{\lim_{x \to a} x - a}.
  \end{align*}
  exists. Therefore
  \begin{align*}
