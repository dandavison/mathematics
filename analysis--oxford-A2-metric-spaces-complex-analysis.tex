...
\item
  \begin{claim*}
    Let $M$ be the space of real $n \times n$ matrices and let $\|A\| = \sup_{v \in U} \|A(v)\|$
    where $U = \{x \in \R^n : \|x\| = 1\}$. Then $\|.\|$ is a norm on $M$.
  \end{claim*}
  \begin{proof}
    ...
    \item {\bf Positivity}:\\
      ...
      sent to a non-zero vector hence $\|A\| > 0$.
    \item {\bf Preserves scalar multiplication}:\\
      We want to show that $\|\lambda A\| = \lambda \|A\|$. Informally, we want to show that the
      ...
      \begin{align*}
        \|\lambda A\| = \sup_{v \in U} \|\lambda A(v)\|
      \end{align*}
      \todo{}
    \item {\bf Triangle inequality}:\\
  ...
  \begin{proof}\hspace{0pt}\\
    \begin{tabular}{ll}
      $(i) \iff (ii)$: &This is \todo{not} the definition of contraction on a metric space.\\
      \\
  ...
  \begin{remark*}
    ...
    $0 < \rho < 1$ such that $\|f(x) - f(y)\| < \rho\|x - y\|$ for all $x, y \in X$.  \todo{Is this
      actually different from $<$? I think so: it rules out the possibility that
      $\sup_{x,y \in X} \|f(x) - f(y)\| = \|x - y\|$.}
  \end{remark*}
...
\item
  ...
  \begin{proof}
    Let $A, B \in M$ and suppose that $\|A\| < 1$. Then
    \begin{align*}
      \|AB\|
      &=    \sup_{v: \|v\| = 1} \|(AB)v\| \\
      &=    \sup_{v: \|v\| = 1} \|A(Bv)\| \\
  ...
  \begin{remark*}
    ...
    pointing from $AB$ to $B$. $I - A$ invertible implies that $B$ is the unique matrix that is
    sent to $B - AB$. It doesn't seem obvious that this is true.
  \end{remark*}
