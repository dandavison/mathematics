...
\subsubsection*{Lim sup and lim inf}
...
\begin{theorem*}[MCT]
  Let $f_n$ be a sequence of non-negative functions such that $f_1 \leq f_2 \leq \cdots$ and $f_n(x) \to f(x)$
  for all $x$. Then
  \begin{align*}
    \lim \int f_n = \int f.
  \end{align*}
...
\begin{theorem*}[DCT]
  Let $f_n$ be a sequence of functions such that $f_n(x) \to f(x)$ for all $x$. Let $g$ be a non-negative
  integrable function such that $|f_n| \leq g$ for all $n$. Then
  \begin{align*}
    \lim \int f_n = \int f.
  \end{align*}
\end{theorem*}
...
\begin{theorem*}[MCT, DCT]
  Let $f_n$ be a sequence of functions such that $f_n(x) \to f(x)$ for all $x$. Then
  \begin{align*}
    \lim \int f_n = \int f
  \end{align*}
  if
  ...
  \item there exists {\it non-negative} and {\it integrable} $g$ such that $|f_n| \leq g$ for all $n$ (DCT).
  \end{enumerate}
\end{theorem*}