...
\begin{theorem*}[MCT]
  Let $f_n$ be a sequence of non-negative functions such that $f_n \to f$ pointwise
  and $f_1 \leq f_2 \leq \cdots$. Then
  \begin{align*}
    \lim \int f_n = \int f.
  \end{align*}
\end{theorem*}
...
\begin{theorem}[Fatou's lemma]
  ...
  \begin{align*}
    \int \liminf_{n\to\infty} f_n \leq \lim_{n\to\infty} \int f_n.
  \end{align*}
\end{theorem}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    &=: \int \limn g_n \\
    &= \limn \int g_n ~~~~~~~\text{(by the monotone converence theorem)}\\
