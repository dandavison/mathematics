...
\begin{claim*}
  Let $f = \ind_A$ where $A \subseteq [0, 1]$. Then there exists $F$ such that $f|_F$ is continuous.
\end{claim*}
...
\begin{intuition}
  ...
  ``outer​'' superset $G$ and restrict ourselves to $E \cup G^c$.
\end{intuition}
...
\begin{proof}
  ...
  Recall that we have $f = \ind_A$ hence $f = 1$ on $E$ and $f = 0$ on $G^c$. We now define a function $g$ that
  agrees with $f$ on $E \cup G^c$.
  ...
  Note that $g$ agrees with $f$ on $E \cup G^c$: for $x \in G^c$ we have $g(x) = 0 = f(x)$,
  since $d(x, E) \geq \delta$. And for $x \in E$ we have $g(x) = 1 = f(x)$.
\end{proof}


\begin{claim*}
  Let $f$ be a simple function. Then there exists $F$ such that $f|_F$ is continuous.
\end{claim*}


\begin{claim*}
  Let $f$ be a measurable function. Then there exists $F$ such that $f|_F$ is continuous.
\end{claim*}
