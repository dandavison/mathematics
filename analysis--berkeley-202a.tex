...
\begin{example}[Random set]
  ...
  \end{align*}
  \red{I don't think we can say the density of $T$ is $0.5$ on every interval $O_i$ because $T$ was known at
    the time when the $O_i$ were chosen, and thus they could be arbitrarily efficient covers of $T$. Of course,
    we know one set on which the density of $T$ is $1$: $T$ itself.}
\end{example}
