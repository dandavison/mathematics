...
\end{mdframed}
(Note that although $f$ does not depend \emph{explicitly} on $t$, it does depend on $t$
through its dependence on $x(t)$ and $\xdot(t)$.)
...
Now, suppose $Q(t)$ is constant. Then its time derivative is zero. Therefore either $\xdot(t) = 0$
or the E-L equations hold.
...
\end{align*}
Recall that we are trying to find a function $y(x)$. Integrating, we have
\begin{align*}
...
\begin{align*}
  ...
  \lambda^2 \int \frac{\xdot^2}{1 + \xdot^2} \dt &= \int (t - C_1)^2 \dt
\end{align*}
...
\begin{align*}
  t + \lambda \frac{\xdot}{\sqrt{1 + \xdot^2}} &= C_1 \\
  \lambda^2 \frac{\xdot^2}{1 + \xdot^2} &= (t - C_1)^2 \\
  \lambda^2 \int \frac{\xdot^2}{1 + \xdot^2} \dx &= (t - C_1)^2x + C_2
\end{align*}
...
\begin{align*}
  \lambda \int \frac{y'}{\sqrt{1 + y'^2}} \dx + \frac{1}{2}x^2 &= C_1x + C_2
\end{align*}
\begin{align*}
  \lambda \int \frac{1}{\sqrt{1 + y'^2}} \dy + \frac{1}{2}x^2 &= C_1x + C_2
\end{align*}


\begin{align*}
  \lambda^2 y'^2 + (x - C)(1 + y'^2) &= 0 \\
  y'^2(\lambda^2 - (C - x)) &= C - x \\
  y' &= \(\frac{\lambda^2}{C - x} - 1\)^{-1/2}
\end{align*}
\begin{align*}
  y = 2\frac{\lambda^2}{(C - x)^2}\(\frac{\lambda^2}{C - x} - 1\)^{1/2}
\end{align*}

To integrate again, we make the substitution $y' = \sinh t$, so that we have
\begin{align*}
  \lambda \tanh t &= -x + C.
\end{align*}
\begin{align*}
  \int \lambda \tanh t \dx = -\frac{1}{2}x^2 + Cx + D
\end{align*}
