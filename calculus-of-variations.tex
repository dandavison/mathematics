...
Recall that if the Lagrangian $f = f(x, \xdot)$ does not depend on $t$ {\it explicitly}, and $x$ is extremal if
it satisfies the alternative form of the Euler-Lagrange equation
\begin{align*}
    f(x, \xdot) - \xdot\pdfdxd = \constant.
\end{align*}
\begin{enumerate}[label=(\alph*)]
\item We have $f(x, \xdot) = \frac{\xdot^2}{x^3}$. Therefore $\pdfdxd = \frac{2\xdot}{x^3}$, and E-L is
  \begin{align*}
...
\begin{align*}
  x(2) = 4 &= \frac{1}{(2C_3 + 1)^2} \\
  2C_3 + 1 &= \pm \frac{1}{4} \\
  C_3      &= -\frac{3}{8}, -\frac{5}{8}.
\end{align*}
