...
\begin{align*}
  A &= \int_{t=0}^{t=1} 2\pi y\dx \\
    &= \int_{x=0}^{x=1} 2\pi x^{2/3}\dx = \left[ 2\pi \cdot \frac{3}{5} x^{5/3} \right]_0^1 = \frac{6\pi}{5}.\\
\end{align*}
Alternatively, as an integral over the t line,
\begin{align*}
  A &= \int_{t=0}^{t=1} 2\pi y\dx \\
    &= \int_{t=0}^{t=1} 2\pi t^2 3t^2 \dt = \left[ \frac{6\pi}{5} t^{4} \right]_0^1 = \frac{6\pi}{5}.\\
\end{align*}
\end{mdframed}
