...
\textbf{Show that $f$ is bounded}\\
\red{Picard's theorem requires that $f$ is bounded within the region of
interest. However, $f \to \mp \infty$ as $x \to \pm \infty$.}

\textbf{Show that $f$ is Lipschitz in the $y$-direction}\\
\red{The partial derivative is $\partiald{f}{y} = (1 - 2x)$ which again is unbounded on $\R$.}
