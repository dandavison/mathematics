...
2: You actually managed to show that $C((0, 1), R)$ is not a metric space, and the metric is only defined on
bounded functions. Of course, this is a failure of compactness, so this works -- but it's worth noting that you
can even find a discrete uncountable set of *bounded* continuous functions on $(0, 1)$.

Aidan Backus, Sep 10 at 6:37am

6: That $I(\phi^-) < I(\phi^+)$ for every $\phi^\pm$ does not imply
that $\sup_{\phi^-} I(\phi^-) < \inf_{\phi^+} I(\phi^+)$. Just look at the sets $(-\infty, 0)$
and $(0, \infty)$ as an example. In fact, in this case, f is Riemann integrable, since there are $\phi^+$ such
that $I(\phi^+)$ is arbitrarily small.
Aidan Backus, Sep 14 at 2:27pm

2. 10 4. 10 6. 7 7. 10 Ian Francis, Sep 16
at 10:37am
